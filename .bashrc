...
echo ${url} | xclip > /dev/null
aplay $HOME/.config/bark.wav &> /dev/null
}
...
frec () {
    ...
    if [ $1 = 'web'  ]; then
        ...
        ffmpeg \
            -video_size ${wd}x${ht}  \
            -framerate 40 -f x11grab \
            -i :0.0 -pix_fmt yuv420p \
            -crf 12 "$fn"
    fi
...
alias dl=" sudo apt-get update; sudo  apt-get install"
alias cp="rsync -rvu --progress"
alias du="du -h"
alias up="sudo apt-get update && sudo apt-get upgrade" 
#alias scrot="scrot $HOME/pictures/shots/%b%d::%H%M%S.png "
alias cls="clear"
alias rm="rm -r"
#alias ssh="ssh phone"
